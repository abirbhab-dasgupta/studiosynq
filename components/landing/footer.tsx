...
const SOCIALS = [
  {
    label: "GitHub",
    href: "https://github.com/abirbhab-dasgupta/studiosynq",
    icon: (
      <svg viewBox="0 0 24 24" width={16} height={16} aria-hidden="true" style={{ fill: "var(--text-2)" }}>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" width={16} height={16} aria-hidden="true" style={{ fill: "var(--text-2)" }}>
        <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.483.201-.921.525-1.234L12 12.6 23.475 4.223c.324.313.525.751.525 1.234z" />
      </svg>
    ),
  },
  {
