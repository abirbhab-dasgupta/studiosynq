...
const navItems = [
    ...
    { label: "Rooms", icon: P.grid, href: "/rooms" },
    { label: "Tasks", icon: P.check, href: "/tasks" },
    { label: "Focus", icon: P.shield, href: "/focus" },
            ...
            {showSignOut && (
                <div style={s({
                    ...
                    <div style={s({
                        ...
                        <p style={s({ fontSize: 15, fontWeight: 500, color: "var(--text)" })}>
                            Sign out?
                        </p>
                        ...
                        return (
                            <button
                                ...
                                <Ico
                                    d={item.icon}
                                    size={13}
                                    stroke={active ? "var(--amber)" : "var(--text-2)"}
                                />
                                {item.label}
                            </button>
                        );
